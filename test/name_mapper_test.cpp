...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::ValuesIn(std::vector<NameIdCase>{
        BuiltInCase("Position"),
        BuiltInCase("PointSize"),
        BuiltInCase("ClipDistance"),
        BuiltInCase("CullDistance"),
        BuiltInCase("VertexId", "VertexID"),
        BuiltInCase("InstanceId", "InstanceID"),
        BuiltInCase("PrimitiveId", "PrimitiveID"),
        BuiltInCase("InvocationId", "InvocationID"),
        BuiltInCase("Layer"),
        BuiltInCase("ViewportIndex"),
        BuiltInCase("TessLevelOuter"),
        BuiltInCase("TessLevelInner"),
        BuiltInCase("TessCoord"),
        BuiltInCase("PatchVertices"),
        BuiltInCase("FragCoord"),
        BuiltInCase("PointCoord"),
        BuiltInCase("FrontFacing"),
        BuiltInCase("SampleId", "SampleID"),
        BuiltInCase("SamplePosition"),
        BuiltInCase("SampleMask"),
        BuiltInCase("FragDepth"),
        BuiltInCase("HelperInvocation"),
        BuiltInCase("NumWorkgroups", "NumWorkGroups"),
        BuiltInCase("WorkgroupSize", "WorkGroupSize"),
        BuiltInCase("WorkgroupId", "WorkGroupID"),
        BuiltInCase("LocalInvocationId", "LocalInvocationID"),
        BuiltInCase("GlobalInvocationId", "GlobalInvocationID"),
        BuiltInCase("LocalInvocationIndex"),
        BuiltInCase("WorkDim"),
        ...
        BuiltInCase("VertexIndex"),
        BuiltInCase("InstanceIndex"),
        BuiltInCase("BaseInstance"),
